...
> Reference: The theoretical framework behind this software is based on the research paper "MATRIX EFFECTS ON GROSS ALPHA DETERMINATION IN ENVIRONMENTAL WATER RESIDUES: AN ANALYTICAL FRAMEWORK BASED ON EFFECTIVE ALPHA-PARTICLE MASS RANGE" authored by Le Dinh Hung et al. (under review).
